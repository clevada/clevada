        ...
        <div class="col-12">
            <nav aria-label="breadcrumb" class="breadcrumb-header">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('admin.config.email') }}">{{ __('Configuration') }}</a></li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="card-body">
            ...
            @if ($message = Session::get('success'))
                <div class="alert alert-success">
                    ...
                    @if ($message == 'test_email_ok') {{ __('Test email sent. Please check your email address or log file') }} @endif
                </div>
            @endif
                    ...
                    <div class="col-12 col-md-4">
                        <div class="form-group">
                            ...
                            <select class="form-select" name="mailgun_endpoint">
                                <option @if(($config->mailgun_secret ?? null) == 'api.mailgun.net') selected @endif value="api.mailgun.net">US Endpoint</option>
                                <option @if(($config->mailgun_secret ?? null) == 'api.eu.mailgun.net') selected @endif value="api.eu.mailgun.net">EU Endpoint</option>
                            </select>
                        </div>
                    </div>
                </div>
...
<section class="section">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('admin.send_test_email') }}" method="post" class="row row-cols-lg-auto g-3 align-items-center">
                @csrf

        ...
        <div class="col-12">
            <nav aria-label="breadcrumb" class="breadcrumb-header">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">{{ __('Modules') }}</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="alert alert-info">
                ...
                <br>
                {{ __('Inactive modules - Administrators and staff (with module permission) have access to manage module and add content, but module is disabled on website') }}.
                <br>
                {{ __('Disabled modules - Module is disabled and it is not displayed in admin or staff area') }}.			
            </div>

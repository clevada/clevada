        ...
        <div class="col-12">
            <nav aria-label="breadcrumb" class="breadcrumb-header">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('admin.config.icons') }}">{{ __('Icons') }}</a></li>
                </ol>
            </nav>
        </div>
    </div>
            ...
            <form method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <div class="form-check form-switch">
                        ...
                        <label class="form-check-label" for="customSwitch">{{ __('Bootstrap icons') }}</label>
                    </div>
                    <div class="form-text">
                        ...
                        {{ __('Note: this icons can not be disabled because there are used in default templates and administration area.') }}
                    </div>
                </div>
                ...
                <div class="form-group mt-4">
                    <div class="form-check form-switch">
                        ...
                        <label class="form-check-label" for="customSwitchBox">{{ __('Box icons') }}</label>
                    </div>
                    <div class="form-text">

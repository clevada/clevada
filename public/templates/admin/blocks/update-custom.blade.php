...
<link rel="stylesheet" href="{{ asset('assets/vendors/prism/prism-live.css') }}">
...
<script src="{{ asset('assets/vendors/prism/bliss.shy.min.js') }}"></script>
<script src="{{ asset('assets/vendors/prism/prism.js') }}"></script>
<script src="{{ asset('assets/vendors/prism/prism-line-numbers.js') }}"></script>
<script src="{{ asset('assets/vendors/prism/prism-live.js') }}"></script>
<script src="{{ asset('assets/vendors/prism/prism-live-markup.js') }}"></script>
<script src="{{ asset('assets/vendors/prism/prism-live-css.js') }}"></script>
<script src="{{ asset('assets/vendors/prism/prism-live-javascript.js') }}"></script>

<div class="row gy-5">
    ...
    <div class="col-12">
        <div class="builder-col sortable" id="sortable_top">
            ...
            @foreach (sidebar_blocks($sidebar->id) as $section)
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <form method="POST" action="{{ route('admin.config.template.content.delete', ['module' => $module, 'template_block_id' => $section->id]) }}">
                                            {{ csrf_field() }}
                                            {{ method_field('DELETE') }}
...
@include('admin.template.modals.layout-add-widget')
        ...
        $("#sortable_top").sortable({
            ...
            update: function(event, ui) {
                ...
                $.ajax({
                    data: data,
                    type: 'POST',
                    url: "{{ route('admin.builder.sortable', ['module' => $module, 'content_id' => $content_id, 'layout' => $layout, 'column' => 'top']) }}",
                });
            }
        });

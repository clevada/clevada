        ...
        <div class="col-12">
            <nav aria-label="breadcrumb" class="breadcrumb-header">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('admin.template.menu') }}">{{ __('Website menu links') }}</a></li>
                </ol>
            </nav>
        </div>
    </div>
                                ...
                                <td>
                                    @foreach ($langs as $lang)
                                        ...
                                        @if ($link->type == 'homepage')
                                            <a target="_blank" href="{{ route('homepage',  ['lang' => ($lang->id == default_lang()->id) ? null : $lang->code]) }}">{{ route('homepage',  ['lang' => ($lang->id == default_lang()->id) ? null : $lang->code]) }}</a>

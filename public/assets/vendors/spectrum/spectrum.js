(function(factory) {
    ...
    var defaultOpts = {
            ...
            theme: "sp-light",
            palette: [
                ["#000000", "#232323", "#3e3e3e", "#5d5d5d", "#747474", "#8b8b8b", "#b9b9b9", "#dadada", "#F0F0F0", "#FFFFFF"],
                ["#1D2D35", "#334E5C", "#3E5F70", "#487084", "#6190A8", "#89ACBE", "#B0C8D4", "#D8E3E9", "#EBF1F4", "#f4f7f8"],
                ["#004480", "#0059a6", "#006dcd", "#0081f3", "#1a94ff", "#40a6ff", "#66b8ff", "#8ccaff", "#b3dbff", "#d9edff"],
                ["#004025", "#006c3f", "#009959", "#00c672", "#00f28c", "#20ffa1", "#4cffb4", "#79ffc7", "#a6ffd9", "#d2ffec"],
                ["#56c564", "#67cb74", "#78d083", "#89d693", "#9adca2", "#aae2b2", "#bbe8c1", "#cceed1", "#ddf3e0", "#eef9f0"],
                ["#6d0005", "#950006", "#bd0008", "#e5000a", "#ff0e19", "#ff373f", "#ff5f66", "#ff878c", "#ffafb2", "#ffd7d9"],
                ["#ff3237", "#ff464b", "#ff5b5f", "#ff6f73", "#ff8487", "#ff989b", "#ffadaf", "#ffc1c3", "#ffd6d7", "#ffeaeb"],
                ["#f06427", "#f2733c", "#f38352", "#f59268", "#f6a27d", "#f8b193", "#f9c1a8", "#fbd0be", "#fce0d4", "#feefe9"],
                ["#ffea29", "#ffec3f", "#ffee54", "#fff069", "#fff27f", "#fff594", "#fff7aa", "#fff9bf", "#fffbd4", "#fffdea"],
                ["#23004f", "#36007a", "#4900a5", "#5d00d0", "#7000fb", "#8728ff", "#9f53ff", "#b77eff", "#cfa9ff", "#e7d4ff"],
                ["#a076d5", "#aa83d9", "#b391de", "#bd9fe2", "#c6ade6", "#d0baea", "#d9c8ee", "#e3d6f2", "#ece4f7", "#f6f1fb"],
                ["#a70065", "#ca0079", "#ec008e", "#ff0f9f", "#ff31ad", "#ff54bb", "#ff76c8", "#ff98d6", "#ffbae4", "#ffddf1"],
                ["#ec008d", "#ff099c", "#ff24a7", "#ff3fb2", "#ff5bbd", "#ff76c8", "#ff92d3", "#ffadde", "#ffc8e9", "#ffe4f4"],
            ],
            selectionPalette: [],
            disabled: false,
            offset: null

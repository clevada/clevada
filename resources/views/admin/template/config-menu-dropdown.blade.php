        ...
        <div class="col-12">
            <nav aria-label="breadcrumb" class="breadcrumb-header">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item" aria-current="page"><a href="{{ route('admin.template.menu') }}">{{ __('Menu links') }}</a></li>
                    <li class="breadcrumb-item active">{{ __('Dropdown links') }} - {{ $parent_link->label }}</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="card-header">
        ...
        <div class="row">
            ...
            <div class="col-12 col-sm-5 col-md-6 order-md-1 order-first">
                <h4 class="card-title">{{ __('Dropdown links') }} - {{ $parent_link->label }}</h4>
            </div>
